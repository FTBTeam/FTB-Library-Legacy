...
public enum ConfigManager implements IConfigManager
{
    ...
    private final ISyncedRegistry<String, IConfigValueProvider> CONFIG_VALUES = new SyncedRegistry<>(new StringIntIDRegistry(), false);
    private final IRegistry<String, IConfigFileProvider> FILE_PROVIDERS = new SimpleRegistry<>(false);
    ...
    @Override
    public ISyncedRegistry<String, IConfigValueProvider> configValues()
    {
        return CONFIG_VALUES;
    }

    @Override
    public IRegistry<String, IConfigFileProvider> fileProviders()
    {
