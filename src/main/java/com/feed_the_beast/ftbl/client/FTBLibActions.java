...
public class FTBLibActions
{
	...
	{
		GuiScreenRegistry.register(new ResourceLocation(FTBLibFinals.MOD_ID, "notifications"), ep -> new GuiNotifications(FTBLibClient.mc.currentScreen));
		GuiScreenRegistry.register(new ResourceLocation(FTBLibFinals.MOD_ID, "friends_gui"), ep -> new GuiInfo(null, new InfoFriendsGUI()));
		GuiScreenRegistry.register(new ResourceLocation(FTBLibFinals.MOD_ID, "client_config"), ep -> new GuiEditConfig(FTBLibClient.mc.currentScreen, ClientConfigRegistry.provider()));
	}
