...
public abstract class GuiHandler //TODO: Make it ResourceLocation + sync with client int IDs
{
    public static final IRegistry<String, GuiHandler> REGISTRY = new RegistryBase<>(RegistryBase.ALLOW_OVERRIDES);
